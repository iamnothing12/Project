...
WINDOWS_CHROME = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.97 Safari/537.36'
...
WINDOWS_FIREFOX = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:72.0) Gecko/20100101 Firefox/72.0'
...
GOOD_STATUS_LIST = [ STATUS_OK, STATUS_CREATED, STATUS_ACCEPTED,STATUS_NO_CONTENT ]
REDIRECT_STATUS_LIST = [ STATUS_MOVED_PERMERNANTLY, STATUS_FOUND, STATUS_SEE_OTHER, STATUS_NOT_MODIFIED, STATUS_TEMPORARY_REDIRECT ]
BAD_STATUS_LIST = [ STATUS_BAD_REQUEST, STATUS_UNAUTHORIZED, STATUS_FORBIDDEN, STATUS_NOT_FOUND, STATUS_METHOD_NOT_ALLOWED, STATUS_NOT_ACCEPTABLE, STATUS_PRECONDITION_FAILED, STATUS_UNSUPPORTED_MEDIA_TYPE ]
SERVER_ERROR_STATUS_LIST = [ STATUS_INTERNAL_SERVER_ERROR, STATUS_NOT_IMPLEMENTED]

#Selenium WebDriver Path
CHROME_WINDOWS="./webdrivers/Chrome/chromedriver_win32/chromedriver.exe"
CHROME_LINUX="./webdrivers/Chrome/chromedriver_linux64/chromedriver"
FIREFOX_WINDOWS="./webdrivers/Firefox/geckodriver-v0.26.0-win64/geckodriver.exe"
FIREFOX_LINUX="./webdrivers/Firefox/geckodriver-v0.26.0-linux64/geckodriver"