...
//Obtain document
javascript:(function(){var ob;ob=document.scripts;console.log('meh');console.log(ob);})();
//Find scripts
javascript:(function(){var ob;ob=document.scripts;console.log('meh');console.log(ob);})();
//Find scripts
javascript:(function(){var ob;ob=document.links;console.log('meh');console.log(ob);})();
